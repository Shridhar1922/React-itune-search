...
const CustomCardNew = styled(Card)`
  && {
    ...
    width:100%;
    background: #ffd700bf;
    box-shadow:0px 0px 5px 0px #ffca36;
    color: ${props => props.color};
    ${props => props.color && `color: ${props.color}`};
  }
`;
...
export function HomeContainer({
        ...
        <CustomCard>
          <Skeleton loading={loading} active>
            ...
            {items.map((item, index) => (
              <Col xs={24} lg={6} md={6} sm={24}>
              <div style={{textAlign:"center",margin:"5px"}}>
              <CustomCardNew key={index}>
                <div>
                <img src={item.artworkUrl100} style={{marginLeft:"auto",marginRight:"auto",textAlign:"center",display:"block",width:"130px"}}/>
                </div>
                <div style={{paddingTop:"10px"}}>
                  <div style={{paddingBottom:"10px"}}><b>Preview Song</b></div>
                <audio
                  controls
                  src={item.previewUrl}
                  style={{width:"100%"}}>
                ...
                <div style={{height:"140px",paddingTop:"10px"}}>
                <div><b> {item.collectionName}</b></div>
  ...
  return (
    ...
    <Container maxwidth={maxwidth} padding={padding}>
      ...
      <CustomCard
        title={intl.formatMessage({ id: 'itune_song_search' })}
        // maxwidth={maxwidth}
      >
